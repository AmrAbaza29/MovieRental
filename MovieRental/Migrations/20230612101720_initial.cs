    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomersMovie", x => new { x.MovieId, x.CustomerId });
                    table.ForeignKey(
                        name: "FK_CustomersMovie_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CustomersMovie_Movies_MovieId",
                        column: x => x.MovieId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomersMovie_CustomerId",
                table: "CustomersMovie",
                column: "CustomerId");
